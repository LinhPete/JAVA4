        ...
        <li class="nav-item dropdown no-arrow osahan-right-navbar-user">
            <a class="nav-link dropdown-toggle user-dropdown-link" href="#" id="userDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img alt="Avatar" src="<%= request.getContextPath() %>/main/img/user.png" width="30px" height="30px" class="rounded-circle">
...
<div class="container-fluid row p-0 m-0">
    <div class="nav nav-pills bg-dark flex-column col-md-2 p-0 sticky-top" style="max-height: 100vh;">
        <li class="nav-item">
            <a class="nav-link text-white rounded-0 ${view=='/main/index.jsp'?'active':''}"
               href="${root}/home">
